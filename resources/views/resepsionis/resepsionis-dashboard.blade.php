        ...
        <div class="flex min-h-screen">
            ...
            <aside class="bg-teal-700 text-white w-64 hidden md:block flex-shrink-0">
                ...
                <nav class="mt-6 space-y-2">
                    ...
                    <a href="{{ route('dashboard.view.pasien') }}" class="block hover:bg-teal-800 px-6 py-3 rounded"><svg
            ...
            <div class="flex-1">
                ...
                <div id="mobileMenu" class="md:hidden bg-teal-700 text-white px-4 py-4 space-y-2 hidden">
                    ...
                    <a href="{{ route('dashboard.view.pasien') }}" class="block hover:bg-teal-800 px-4 py-2 rounded"><svg
                            xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px"
                            fill="#FFFFFF" class="inline">
                            <path d="M0 0h24v24H0z" fill="none" />
                            <path
