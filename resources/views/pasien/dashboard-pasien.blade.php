        ...
        <div class="flex min-h-screen">
            ...
            <aside class="bg-teal-700 text-white w-64 hidden md:block flex-shrink-0">
                ...
                <nav class="mt-6 space-y-2">
                    <a href="{{ route('dashboard.pasien') }}" class="block hover:bg-teal-800 px-6 py-3 rounded">🏠
                        Home</a>
                    <a href="{{ route('jadwal.konsultasi') }}" class="block px-6 py-3 hover:bg-teal-800 transition">🗓️ Jadwal Rekam Medis</a>
            ...
            <div class="flex-1">
                ...
                <header class="bg-white shadow px-6 py-4 flex justify-between items-center">
                    <h1 class="text-xl font-semibold text-gray-800">Dashboard {{ $patient->name }}</h1>
                ...
                <div id="mobileMenu" class="md:hidden bg-teal-700 text-white px-4 py-4 space-y-2 hidden">
                    <a href="{{ route('dashboard.pasien') }}" class="block hover:bg-teal-800 px-4 py-2 rounded">🏥
                        Home</a>
                    <a href="{{ route('jadwal.konsultasi') }}" class="block hover:bg-teal-800 px-4 py-2 rounded">🏥 Jadwal Rekam Medis</a>
                ...
                <main class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <!-- Card 3 -->
                        <a href="{{ route('konsultasi.pasien') }}"
                            class="bg-white rounded-xl shadow hover:bg-teal-50 p-6 border-l-4 border-teal-500 transition">
                            <h2 class="text-lg font-bold mb-1">Buat Konsultasi Baru</h2>
                            <p class="text-sm text-gray-600">Mulai konsultasi dengan dokter</p>
                        </a>
