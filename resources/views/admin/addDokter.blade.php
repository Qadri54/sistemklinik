        ...
        <div class="flex min-h-screen">
            ...
            <div class="flex-1">
                ...
                <div class="container mx-auto px-4 py-6">
                    ...
                    <form method="POST" action="{{ route('admin.add.doctors') }}">
                        @csrf
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div>
                                    <label for="specialization" class="block font-semibold mb-1">Spesialisasi</label>
                                    <select name="specialization" id="specialization"
                                        class="px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-300">
                                        <option value="">-- Semua Spesialisasi --</option>
                                        <option value="Umum"=='Umum'>Umum
                                        </option>
                                        <option value="Anak"=='Anak'>Anak
                                        </option>
                                        <option value="Gigi"=='Gigi'>Gigi
                                        </option>
                                        <option value="THT"=='THT'>THT
                                        </option>
                                        <option value="Kulit"=='Kulit'>Kulit
                                        </option>
                                        <option value="Saraf"=='Saraf'>Saraf
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mb-2">
                                    <label for="birth_date" class="block font-semibold mb-1">Tangaal Lahir</label>
